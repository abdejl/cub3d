...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/14 10:16:21 by yael-bar          #+#    #+#             */
/*   Updated: 2025/12/14 10:38:25 by yael-bar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*--------------raycasting--------------------*/
double				distance_between_2(double x1, double y1, double x2,
						double y2);
...
/*---------------------passing texture--------------------*/
void				handle_n_texture(char *s, int *i, int *copy_i,
						t_counters *cnt);
void				handle_so_texture(char *s, int *i, int *copy_i,
						t_counters *cnt);
void				handle_w_texture(char *s, int *i, int *copy_i,
						t_counters *cnt);
void				handle_e_texture(char *s, int *i, int *copy_i,
						t_counters *cnt);
void				process_texture(char *s, int *i, int *copy_i,
						t_counters *cnt);
